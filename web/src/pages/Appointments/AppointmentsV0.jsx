...
export default function AppointmentsV0() {
  const { user } = useAuth();
              ...
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                <div className="space-y-3 max-w-md">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    We're building a comprehensive appointment management system. 
                ...
                <div className="bg-muted rounded-lg p-6 max-w-lg w-full">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-2 text-left">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Book appointments with mental health professionals</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-0.5">•</span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-0.5">•</span>
                      <span>Video call integration for online sessions</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-0.5">•</span>
                      <span>Session notes and follow-up reminders</span>
                    </li>
                  </ul>
                </div>
